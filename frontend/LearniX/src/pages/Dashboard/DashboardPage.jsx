        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          ...
          (dashboardData.recentActivity.documents?.length > 0 ||
            ...
            <div className="space-y-3">
              {[
                ...
                .map((activity) => (
                  <div
                    key={activity.id}
                    className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/60 border border-slate-200/60 hover:bg-white hover:shadow-md transition-all duration-200"
                  >
                    ...
                    <a
                      href={activity.link}
                      className="ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition"
                    >
                      View
                    </a>
                  </div>
            ...
            <div className="text-center py-12">
              <Clock className="w-8 h-8 mx-auto text-slate-400 mb-4" />
