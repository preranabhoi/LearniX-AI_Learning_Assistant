    ...
    <div className="max-w-5xl mx-auto">
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-100 border-rose-300 rounded-lg text-xs font-semibold text-rose-700">
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl translate-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden">
